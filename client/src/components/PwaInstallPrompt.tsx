...
import { getPwaInstallSurface, isIosDevice, isStandaloneMode, shouldOfferPwaInstall } from "@/lib/pwa";
...
export default function PwaInstallPrompt() {
  ...
  if (loading || !shouldOfferPwaInstall({ isAuthenticated: Boolean(user), installed, dismissed, hasInstallEvent: Boolean(installEvent), ios, isMobile })) return null;
