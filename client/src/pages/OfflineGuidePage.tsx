...
export default function OfflineGuidePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f5ee] text-[#243029]">
      <header className="border-b border-[#d6d9ce] bg-[#f7f5ee]"><div className="container flex min-h-18 items-center justify-between gap-4 py-4"><a href="/" className="inline-flex items-center gap-3 rounded-md font-serif text-2xl text-[#243029] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#567b4f]"><span className="grid size-9 place-items-center rounded-xl bg-[#d1e980] text-sm font-sans font-bold text-[#1e2924]">E</span>EASYSTOR</a><div className="flex items-center gap-2 sm:gap-4"><a href="/guides" className="rounded-md px-2 py-2 text-sm font-bold text-[#304631] underline-offset-4 hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#567b4f]">Guides</a><a href="/auth?mode=login" className="rounded-md px-2 py-2 text-sm font-bold text-[#304631] underline-offset-4 hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#567b4f]">Se connecter</a></div></div></header>
      <main>
